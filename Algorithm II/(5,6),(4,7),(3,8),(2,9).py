...
def check_counter(threshold, m, lst):
    print("the pairs (5,6),(4,7),(3,8),(2,9) are checked and the result is :",len(lst) == m - threshold + 1)

# Ex: (5,6),(4,7),(3,8),(2,9)
# It suffices to check integers between 10000 and 1.666*10^6 can be written as sums of at most 2 icosahedral numbers
# and 4 dodecahedral numbers.
...
for j in ico_second_step_combinations:
    for i in dode_fourth_step_combinations:
